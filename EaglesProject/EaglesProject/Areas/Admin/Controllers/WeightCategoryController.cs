...
namespace EaglesProject.Areas.Admin.Controllers
{
    ...
    public class WeightCategoryController : Controller
    {
        ...
        public async Task<IActionResult> Save(TbWeightCategory ITEM, int id, List<IFormFile> files)
        {
            ...
            if (ITEM.WeightCategoryId == Guid.Parse("00000000-0000-0000-0000-000000000000"))
            {
                ...
                weightCategoryService.Add(ITEM);
            ...
            else
            {
                ...
                weightCategoryService.Edit(ITEM);
        ...
        public IActionResult Delete(Guid id)
        {
            ...
            TbWeightCategory oldItem = ctx.TbWeightCategories.Where(a => a.WeightCategoryId == id).FirstOrDefault();

            weightCategoryService.Delete(oldItem);
